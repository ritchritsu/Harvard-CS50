...
double sepiaRed, sepiaBlue, sepiaGreen;

    for (int i = 0; i < height; i++)
    {
        for (int j = 0; j < width; j++)
        {
            sepiaRed = (int)round (  (double)(image[i][j].rgbtRed *0.393) + (double)(image[i][j].rgbtGreen *0.769) + (double)(image[i][j].rgbtBlue *0.189)  );
            sepiaGreen = (int)round (  (double)(image[i][j].rgbtRed *0.349) + (double)(image[i][j].rgbtGreen *0.686) + (double)(image[i][j].rgbtBlue *0.168)  );
            sepiaBlue = (int)round (  (double)(image[i][j].rgbtRed *0.272) + (double)(image[i][j].rgbtGreen *0.534) + (double)(image[i][j].rgbtBlue *0.131)  );
